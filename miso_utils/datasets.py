...
def create_val_dataset( path, miso_count = 30000, nmiso_count = 30000, image_transform = square_tensor_transform, shuffule = False, shuffle_seed = 42,deciding_label = "indian_label"):
...
def create_train_dataset( path, miso_count = 30000, nmiso_count = 30000, image_transform = square_tensor_transform, shuffule = False, shuffle_seed = 42,deciding_label = "indian_label"):
    return MisoDataset(path, 
...
class MisoDataset(Dataset):
    def __init__(self, path, label_file,miso_count = 30000, nmiso_count = 30000, image_transform = square_tensor_transform, shuffule = False, shuffle_seed = 42,deciding_label = "indian_label"):
        super().__init__()
